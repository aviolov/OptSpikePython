...
TABLES_DIR = '/home/alex/Workspaces/Python/OptSpike/Results/'

for D in [TABLES_DIR]:
    if not os.path.exists(D):
        os.mkdir(D)
        
default_h5file_name = 'OptSpike'

from tables import *       

class Path(IsDescription):
    Tf = Float32Col()
    dt = Float32Col()
    mu = Float32Col()
    tau_char = Float32Col()
...
class DataHarvester(object):
    ...
    def __init__(self, table_file_name=default_h5file_name):
        '''
